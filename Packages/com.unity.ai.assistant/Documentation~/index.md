...
| Topic | Description |
| ----- | ----------- |
| [Get started with Assistant](xref:install-config) | Install Assistant, open it in the Unity Editor, and learn about its modes and capabilities. |
...
- [Monitor AI usage](https://cloud.unity.com/home/ai/usage)
- [Manage AI point balance](https://cloud.unity.com/home/ai/points)
- [Configure AI settings](https://cloud.unity.com/home/ai/settings)
